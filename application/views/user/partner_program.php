      ...
      <div class="referral-card" id="referral-card">
        <div class="referral-card__content">
          ...
          <div class="referral-card__text">
            ...
            ?>
            <p class="referral-card__code <?php echo $isApproved ? 'approved' : ''; ?>" id="referral-code"><?php echo $referal_code_txt;?></p>
          </div>
          <?php if($isApproved){ ?>
          <button class="referral-card__copy-btn" id="copy-code-btn" onclick="copyReferralCode('<?php echo $refData[0]['referal_code']; ?>')">
